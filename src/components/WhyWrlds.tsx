...
const WhyWrlds = () => {
  ...
  // Simplified animations for mobile to prevent lag
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        ...
        margin: "-100px"
          ...
          <motion.div variants={itemVariants} className="bg-gray-100 p-6 rounded-xl border border-gray-200 text-center hover:bg-gray-200 transition-all">
            ...
            <h3 className="text-gray-900 text-2xl lg:text-3xl font-bold mb-3">
              <AnimatedCounter end={60} suffix="%" /> Fail
            </h3>
            <p className="text-gray-700">
              of IoT projects stall at proof-of-concept. Not with WRLDS — we get you to market.
            </p>
          </motion.div>
          ...
          <motion.div variants={containerVariants} className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <motion.div variants={itemVariants} className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-xl border border-gray-200 hover:shadow-lg transition-all">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-xl font-bold text-gray-900 mb-2">Turnkey Development</h4>
                  <p className="text-gray-700">We handle the tech complexity so you can focus on your core business.</p>
                </div>
              </div>
            </motion.div>
