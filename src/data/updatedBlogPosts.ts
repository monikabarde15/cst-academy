...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: [
      ...
      {
        type: 'paragraph',
        content: 'We\'re widening the story again. Textile IoT stays in our toolbox, but it\'s not our boundary. We\'re now showcasing the full end-to-end capabilities we\'ve built over 7+ years of shipping connected products across sports, gaming, industrial and defense.'
      },
      {
        type: 'heading',
        content: 'Deep Hardware Expertise'
      },
      {
        type: 'icon-list',
        items: [
          ...
          'Embedded hardware, drivers and firmware',
          'Power architecture for battery life',
          'RF design and connectivity (BLE, LTE, Wi-Fi)',
          'Enclosure and mechanical integration',
          'DFM and production test plans'
        ]
      },
      {
        type: 'paragraph',
        content: 'We plan for compliance early and guide you through CE, FCC, RED and related certifications.'
      },
      {
        type: 'heading',
        content: 'Our Modular Stack'
      },
      {
        type: 'icon-list',
        items: [
          'Sensing and embedded algorithms',
          'Connectivity and secure device management with OTA',
      ...
      {
        type: 'paragraph',
        content: 'These modules shorten the path to a working concept while leaving room for custom features where they matter most.'
      },
      {
        type: 'heading',
        content: 'Examples in Market'
      },
      {
        type: 'subheading',
        content: 'Real-Time Personnel Surveillance'
      },
      {
        type: 'paragraph',
        content: 'Wearable monitoring systems for military, police, medical, and firefighter personnel providing real-time status and location tracking in critical situations.'
      },
      {
        type: 'subheading',
        content: 'Smart Athletic Training'
      },
      {
        type: 'paragraph',
        content: 'Embedded motion sensing feeds a mobile app that shows progress after every session.'
      },
      {
        type: 'subheading',
        content: 'Connected Play and Venues'
      },
      {
        type: 'paragraph',
        content: 'Large-scale installations capture movement and usage, turning it into insights for safety and maintenance.'
      },
      {
        type: 'heading',
        content: 'Who We Are For'
      },
      {
        type: 'icon-list',
        items: [
          'Product owners with a clear user problem and first market',
          'Teams that want a working concept in weeks',
          'Organizations that value confidentiality and security'
        ]
      },
      {
        type: 'heading',
      ...
      },
      {
        ...
        items: [
          'Book a short call',
          'Share the user problem and success metric',
          'Get a two-week plan to reach a tangible concept'
        ]
      }
    ]
  },
